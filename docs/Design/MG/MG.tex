...
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The format of the
  initial input data.
\item[\refstepcounter{acnum} \actheacnum \label{acInputConstraints}:] The constraints over the input parameters.
\item[\refstepcounter{acnum} \actheacnum \label{acUseage}:] The usage of \progname{} as a `stand alone' program.
\item[\refstepcounter{acnum} \actheacnum \label{acWavelet}:] The shapes of the wavelets used in the wavelet transform, currently only one shape is offered, but in future iterations may offer many shapes and the user may be able to specify which shape of wavelet to use. 
\item[\refstepcounter{acnum} \actheacnum \label{acResolution}:] The resolution of the time-frequency transform (the output). 
\item[\refstepcounter{acnum} \actheacnum \label{acPlotting}:] The usage of the Plotting Module.
\item[\refstepcounter{acnum} \actheacnum \label{acBoundrycondtion}:] The users control over the boundary conditions.
\item[\refstepcounter{acnum} \actheacnum \label{acImpWavelet}:] The implementation of the wavelet transform computation. 
\item[\refstepcounter{acnum} \actheacnum \label{acImpSTFT}:] The implementation of the STFT transform computation. 
\end{description}
...
\item[\refstepcounter{ucnum} \uctheucnum \label{ucOutputformat}:] The output format of the transform.
\item[\refstepcounter{ucnum} \uctheucnum \label{ucZeropad}:] The Zero-pad module is unlikely to be replaced by a different method (there are different methods but they would not provide any better service).
\item[\refstepcounter{ucnum} \uctheucnum \label{ucOutputVerify}:] The methods of output verification, in the context of \progname{}, are very simple and therefore unlikly to change.
\item[\refstepcounter{ucnum} \uctheucnum \label{ucGoal}:] The purpose of \progname{} being to analyse the time-frequency content of a signal.
\end{description}
...
\item [\refstepcounter{mnum} \mthemnum \label{mSpecParam}:] Specification Param Module
\item [\refstepcounter{mnum} \mthemnum \label{mMatrix}:] Matrix Data Structure Module
\item [\refstepcounter{mnum} \mthemnum \label{mInputParam}:] Input Parameter Module 
\item [\refstepcounter{mnum} \mthemnum \label{mReadData}:] Read Data Module
\item [\refstepcounter{mnum} \mthemnum \label{mZeroPad}:] Zero-Pad Module
\item [\refstepcounter{mnum} \mthemnum \label{mBoundry}:] Boundary Configuration Module
\item [\refstepcounter{mnum} \mthemnum \label{mSTFT}:] STFT Module
\item [\refstepcounter{mnum} \mthemnum \label{mWavelet}:] Wavelet Module
\item [\refstepcounter{mnum} \mthemnum \label{mFFT}:] Fast Fourier Transform Module 
\item [\refstepcounter{mnum} \mthemnum \label{mOutputVerify}:] Output Verification Module
...
\item [\refstepcounter{mnum} \mthemnum \label{mTransform}:] Compute Transform Module  \item [\refstepcounter{mnum} \mthemnum \label{mControl}:] Control Module
\end{description}
